...
public class RoomBean {
	...
	private Room.ControlModel controlModel= Room.ControlModel.s1;//控制模式
...
//	put("STOPSPEAK","禁言#INTEGER#1");//0否 1是
	...
	public Room.ControlModel getControlModel() {
		return controlModel;
	}
	public void setControlModel(Room.ControlModel controlModel) {
