...
public class MemberBean {
	...
	private Member.MEMBER_TYPE member_type;
...
//	}
	...
	public Member.MEMBER_TYPE getMember_type() {
		return member_type;
	}
	public void setMember_type(Member.MEMBER_TYPE member_type) {
	...
	public Double getMoney(RoomBean rb) {
		if(rb.getIndependence()==1&&this.member_type!= Member.MEMBER_TYPE.ROBOT) {
