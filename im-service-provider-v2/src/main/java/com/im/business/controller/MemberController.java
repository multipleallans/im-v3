...
import com.im.business.bean.store.ChatStoreComponent;
...
import com.im.util.BeanUtils;
import com.im.util.MD5;
import com.im.util.ResponseUtils;
...
//        }
        ...
        if (null == list || list.isEmpty()) {
            ...
            if (member.getMemberType() == MemberType.ROBOT) {
...
//            String userIp = WebUtilsWeb.getIpAddr(request);
            ...
            mb.setMemberType(member.getMemberType());
...
//            mb.setLastLoginIp(userIp);
            ...
            mb.setPreBank_addr(member.getPreBankAddr());
            mb.setPreBank_belonger(member.getPreBankBelonger());
            mb.setPreBank_code(member.getPreBankCode());
            mb.setPreBank_name(member.getPreBankName());
